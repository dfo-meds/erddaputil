...
class ErddapDatasetManager:
    ...
    def __init__(self):
        ...
        self._max_recompilation_delay = self.config.as_int(("erddaputil", "dataset_reloader", "max_recompile_delay"), default=15)
        self._skip_errored_datasets = self.config.as_bool(("erddaputil", "dataset_reloader", "skip_misconfigured_datasets"), default=True)
